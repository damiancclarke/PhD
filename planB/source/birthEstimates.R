...
full   <- FALSE #requires stargazer package which is very slow
                #should be changed to use texreg
...
filename <- paste(brth.dir, 'birthsComunaAge.csv' ,sep="")
...
#=== (3b) Load Data
#==============================================================================
f <- paste(brth.dir, "birthsComunaAge.csv", sep="")
orig <- read.csv(f)
...
# Back of the envelope calculation of births
...
#==============================================================================
#=== (5b) Estimate event study and plot figures
#==============================================================================
...
if(full) {
  stargazer(full1519, full2034,  full3549,
          ...
          notes="\\begin{footnotesize} \\textsc{Notes:} Each model is identical to 
            ...
            variable is also provided in table \\ref{TEENtab:PillPreg}.
            Municipality dummies and trends and political party dummies have been
            omitted for clarity. ^{*}p$<$0.1; ^{**}p$<$0.05; ^{***}p$<$0.01 
            \\end{footnotesize}",
