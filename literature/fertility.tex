...
models or hypotheses regarding behavioural or biological mechanisms. A correctly
estimated parameter in the fertility literature is generally of interest given 
its relation to deeper behavioural or technological implications rather than as
a curio in its own right.  And in the second case, these behavioural or 
technological implications are extremely relevant for policies implicitly or
explicitly designed to impact human wellbeing.  I discuss these `whys' in what
...
regarding household fertility decisions.  Perhaps most central to these


\begin{itemize}
\item Why important
\item Discussion on Q--Q
\end{itemize}
