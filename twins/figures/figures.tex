...
\label{TWINfig:bord}
\includegraphics[scale=0.92]{\twinloc/figures/twinbybord.eps} 
\end{center}
\end{figure}
...
\includegraphics[scale=0.86]{\twinloc/figures/height_country.eps} 
\end{center}
\end{figure}
...
\label{TWINfig:ltz2}
\includegraphics[scale=0.88]{\twinloc/figures/LTZ_two.eps}
\vspace{-8mm}
...
\label{TWINfig:ltz3}
\includegraphics[scale=0.88]{\twinloc/figures/LTZ_three.eps} 
