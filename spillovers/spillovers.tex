...
This is not the first study to examine the estimation of spillovers 
...
\nonumber
 R(i,t) =
  ...
  \end{cases}
\end{equation}
%Where $X(i,t)$ is an individual covariate measuring distance (in a very 
%general sense) to treatment and $f(\cdot)$ is a positive monotone function. 
...
out below.
%, so long as spillovers are montononic in $X$.
...
\asref{Sass:SUTVAl}{A}.  In order to do this, the following new terminology is 
...
\input{\sdidloc/tables/ChileSum.tex}
