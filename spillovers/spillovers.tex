...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[scale=0.32]{\sdidloc/figures/Event1519treat.eps}
  \caption{Full Event Study: Treatment}
  \label{Sfig:eventT}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[scale=0.32]{\sdidloc/figures/Event1519close.eps}
...
Firstly, I calculated the shortest distance over roads from non-treatment to 
