...
********************************************************************************
global DAT "./twins/data/IPUMS"
global OUT "./twins/results/gamma"
...
merge m:1 birth_year birth_state using "$DAT/sulfaStateData"
keep if _merge==3

save "$DAT/IPUMS1980_sulfa", replace

********************************************************************************
*** (5) Estimate Sulfa effect on child quality
********************************************************************************
use "$DAT/IPUMS1980_sulfa"
...
graph export "$FIG/gammaResamp.eps", as(eps) replace
...
tw hist gamma, bin(12) yaxis(2) frac || line lN x, yaxis(1)                  ///
    ...
    legend(label(1 "Empirical Distribution") label(2 "Analytical Distribution")) 
graph export "$FIG/gammaLogN.eps", as(eps) replace
