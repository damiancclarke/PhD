...
log using "$LOG/NHISPrep.txt", text replace



foreach yrr of numlist 2014(-1)2004 {
global DAT "./twins/data/NHIS/`yrr'"
...
gen surveyQuarter = floor(surveyMonth/3)
gen birthQuarter  = floor(childMonthBirth/3)

gen ageInterview=(surveyYear-childYearBirth)+(surveyMonth-childMonthBirth-1)/12
