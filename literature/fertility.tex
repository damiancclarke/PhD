...
Gynaecological Papyrus \citep{OdowdPhillip1994}.  Estimates suggest that today,
...
percent of Catholic residents in a state.}  However, directly testing for the
...
(although it can imply this if local access reforms are extremely tightly 
controlled).  Fortunatly, violations of this type will, at worst, bias 
downwards  estimated results.  Often concerns such as these are examined
...
contraceptive pill: \citet{Bailey2006,Christensen2012}
LR pill:\citet{Bailey2011,Bailey2013,Bailey2012} 



Split into short run and long run
\citet{Guldi2008,KearnerLevine2009,Levineetal1999,AngristEvans1996,
...
\emph{causal} analysis of parent outcomes, the specifications discussed above 
can only act as a first-stage effect.  In turning to causal estimates, we
are interested in the quantifying the effect on outcomes which flows from 
changes in fertility, rather than the reform itself.
...
\citet{Bailey2006,Bailey2013} also looks at FLFP.  \citet{Christensen2012} looks
at cohabitation.
