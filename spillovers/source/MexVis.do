...
********************************************************************************
global BIR "./spillovers/data"
global DAT "./spillovers/tables"
global OUT "./spillovers/figures"
...
*** (4) Chile
********************************************************************************
insheet using "$DAT/close1519.csv", delim(",") names clear
...
graph export "$OUT/CloseEstimate1.eps", as(eps) replace

insheet using "$DAT/close2034.csv", delim(",") names clear
...
twoway line beta distance || line up1 distance, lpattern(dash) ///
  ...
  yline(0, lpattern(dot)) legend(order(1 "Point Estimate" 2 "90% CI")) ///
  xtitle("Distance") ytitle("Pr(Birth)" " ") xlabel(minmax)
graph export "$OUT/CloseEstimate2.eps", as(eps) replace
