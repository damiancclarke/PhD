...
# source files:
#    > birthsComunaAge.csv - the file recording births and pill status
#    > deathsComunaAge.csv   - the file recording fetal deaths and pill
#
...
#*******************************************************************************
births <- read.csv(paste(brth.dir,"birthsComunaAge.csv", sep=""))
deaths <- read.csv(paste(deth.dir,"deathsComunaAge.csv", sep=""))
...
fB <- paste(cod.dir,"birthGenerate.R",sep="")
fD <- paste(cod.dir,"deathGenerate.R",sep="")
source(fB)
source(fD)  
filenameB <- paste(brth.dir, 'births_20002012.csv' ,sep="")
filenameD <- paste(deth.dir, 'deaths_20002012.csv', sep="")
...
#***(6e) Long trends
#*******************************************************************************
f <- paste(brth.dir, "births_20002012.csv", sep="")
orig <- read.csv(f)
...
f <- paste(deth.dir, "deaths_20002012.csv", sep="")
orig <- read.csv(f)
...
#*******************************************************************************
#***(7) Summary Plots (age histograms)
#*******************************************************************************
