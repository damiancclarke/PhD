...
save "$DAT/AppendedBirths.dta", replace
...
save "$DAT/AppendedBirthsEarly.dta", replace
...
save "$DAT/AppendedBirths90s.dta", replace
...
save "$DAT/AppendedFDeaths.dta", replace
...
save "$DAT/AppendedFDeaths90s.dta", replace
